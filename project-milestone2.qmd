...
trump_mod4 <- glm(trump_approval ~ income * science_support + degree, family = "binomial", data = pulse)
summary(trump_mod4)
exp(coef(trump_mod4))
...
$$
E[trumpapproval|income, sciencesupport, degree] = \beta_0 + \beta_1income + \beta_2sciencesupport + \beta_3income*sciencesupport + \beta_4degree
$$
